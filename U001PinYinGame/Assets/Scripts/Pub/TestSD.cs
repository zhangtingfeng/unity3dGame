...
public class TestSD
{
    ...
    public void ReadSD()
    {
        try
        {
            ...
            string s01 = jc.CallStatic<string>("ReadSD", getStoragePath()+"/externalResources/settings.xml");
            Debug_Log.Call_WriteLog(s01, getStoragePath() + "/externalResources/settings.xml", "001PinYIn");
