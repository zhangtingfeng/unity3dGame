...
public class MicroPhoneManager : MonoBehaviour
{
    ...
    public void StartRecordAudio()
    {
        ...
        CurAudioSource.clip = Microphone.Start(null, true, 1000, int.Parse(Frequency));
    ...
    public void StopRecordAudio()
    {
        ...
        AudioSave.Save("C:\\Users\\Administrator\\AppData\\LocalLow\\DefaultCompany\\U001PinYinGame\\11.wav",CurAudioSource.clip);
    ...
    public void PrintRecordData()
    {
        ...
        {
            Debug_Log.Call_WriteLog(eeee, "录音问题", "001pinyin");
        }
    }
