...
public abstract class BaseOnMouse : MonoBehaviour
{
    ...
    protected void OnClick(BaseEventData pointData)
    {
        ...
        //yyyyy++;
        //Debug_Log.Call_WriteLog("Button Clicked. EventTrigger..=");
        setClickButton();
    ...
    private void OnMouseEnter(BaseEventData pointData)
    {
        ...
        //yyyyy++;
        //Debug_Log.Call_WriteLog("BaseOnMouse Enter. EventTrigger..=" + yyyyy);
    }
    ...
    private void OnMouseLeave(BaseEventData pointData)
    {
        ...
        //yyyyy++;
        //Debug_Log.Call_WriteLog("BaseOnMouse OnMouseLeave. EventTrigger..=" + yyyyy);
    }
}
